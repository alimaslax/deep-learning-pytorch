...
default_tokenizer_name = "unsloth/llama-3-8b-Instruct-bnb-4bit"
default_dataset_name = "../data/processed_data/mali_llama3_instruct_dataset"
default_new_model = "mali-llama3-8b-Instruct"
...
parser.add_argument("--model_name", type=str, default=default_model_name, help="Name of the model to train")
...
parser.add_argument("--dataset_name", type=str, default=default_dataset_name, help="Name of the dataset")
parser.add_argument("--new_model", type=str, default=default_new_model, help="Name of the trained model")
